var A=Object.defineProperty;var T=(o,e,t)=>e in o?A(o,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):o[e]=t;var h=(o,e,t)=>(T(o,typeof e!="symbol"?e+"":e,t),t),C=(o,e,t)=>{if(!e.has(o))throw TypeError("Cannot "+t)};var u=(o,e,t)=>(C(o,e,"read from private field"),t?t.call(o):e.get(o)),_=(o,e,t)=>{if(e.has(o))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(o):e.set(o,t)};import{html as n,LitElement as R}from"../lit-all.min.js";var i=class{constructor(e,t){this.key=Symbol("match-media-key"),this.matches=!1,this.host=e,this.host.addController(this),this.media=window.matchMedia(t),this.matches=this.media.matches,this.onChange=this.onChange.bind(this),e.addController(this)}hostConnected(){var e;(e=this.media)==null||e.addEventListener("change",this.onChange)}hostDisconnected(){var e;(e=this.media)==null||e.removeEventListener("change",this.onChange)}onChange(e){this.matches!==e.matches&&(this.matches=e.matches,this.host.requestUpdate(this.key,!this.matches))}};import{css as y}from"../lit-all.min.js";var S=y`
    :host {
...
`;var l="merch-offer-select:ready";var E="merch-offer:selected",d="merch-stock:change";var p="merch-quantity-selector:change";var x="(max-width: 1199px)";var c,r=class extends R{constructor(){super();_(this,c,new i(this,x));this.ready=!1,this.continueText="Continue"}get listLayout(){return n`
